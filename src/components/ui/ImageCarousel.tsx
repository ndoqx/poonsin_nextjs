...
import { SITE_CONFIG, CategoryKey } from '@/lib/site-config';
    ...
    >
      {images.map((img, idx) => (
        <img
          ...
          src={img}
          alt={`Slide ${idx}`}
          className={`absolute inset-0 w-full h-full object-cover transition-opacity duration-1000 ease-in-out pointer-events-none transform group-hover:scale-105 ${
