    ...
    <section id="collection" className="bg-white text-gray-900 py-24 md:py-40 px-6 relative z-20 shadow-[0_-20px_50px_rgba(0,0,0,0.02)]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-24 md:space-y-40">
          ...
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16 group">
            <Reveal effect="fade-right" className="md:w-1/2 order-2 md:order-1 text-center md:text-left">
              <p className="text-amber-600 font-bold tracking-widest text-xs md:text-sm mb-3 uppercase flex items-center justify-center md:justify-start gap-2">
                <span className="w-6 md:w-8 h-px bg-amber-600 block"></span> Modern Series
              </p>
              <h3 className="text-3xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-4 md:mb-6">ศาลโมเดิร์น.</h3>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4 font-semibold">
                <button onClick={() => scrollToSection('contact')} className="w-full sm:w-auto text-white bg-gray-900 px-8 py-3 md:py-4 rounded-full hover:bg-amber-600 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                  ติดต่อสั่งทำ
                </button>
                <button onClick={() => setActiveCategory('modern')} className="w-full sm:w-auto text-gray-900 bg-white border border-gray-200 px-6 py-3 md:py-4 rounded-full hover:border-amber-500 hover:text-amber-600 hover:shadow-md transition-all duration-300 flex items-center justify-center gap-2">
          ...
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16 group">
            <Reveal effect="fade-right" delay={100} className="md:w-1/2 relative w-full">
            ...
            <Reveal effect="fade-left" className="md:w-1/2 text-center md:text-left">
              <p className="text-amber-600 font-bold tracking-widest text-xs md:text-sm mb-3 uppercase flex items-center justify-center md:justify-start gap-2">
                <span className="w-6 md:w-8 h-px bg-amber-600 block"></span> Classic Heritage
              </p>
              <h3 className="text-3xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-4 md:mb-6 text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-amber-700">
                ศาลพระภูมิ และ<br className="hidden md:block"/>ศาลเจ้าที่.
              </h3>
              <p className="text-base md:text-lg lg:text-xl text-gray-600 mb-8 md:mb-10 leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4 font-semibold">
                <button onClick={() => scrollToSection('contact')} className="w-full sm:w-auto text-white bg-gradient-to-r from-amber-500 to-amber-700 px-8 py-3 md:py-4 rounded-full hover:shadow-lg hover:shadow-amber-500/30 hover:-translate-y-1 transition-all duration-300">
                  ติดต่อสั่งทำ
                </button>
                <button onClick={() => setActiveCategory('classic')} className="w-full sm:w-auto text-gray-900 bg-white border border-gray-200 px-6 py-3 md:py-4 rounded-full hover:border-amber-500 hover:text-amber-600 hover:shadow-md transition-all duration-300 flex items-center justify-center gap-2">
                  <Search size={20} /> ดูทุกรุ่นในหมวดนี้
                </button>
              </div>
            </Reveal>
          ...
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16 group">
            <Reveal effect="fade-right" className="md:w-1/2 order-2 md:order-1 text-center md:text-left">
              <p className="text-amber-600 font-bold tracking-widest text-xs md:text-sm mb-3 uppercase flex items-center justify-center md:justify-start gap-2">
                <span className="w-6 md:w-8 h-px bg-amber-600 block"></span> The Grand Brahma
              </p>
              <h3 className="text-3xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-4 md:mb-6">ศาลพระพรหม.</h3>
              <p className="text-base md:text-lg lg:text-xl text-gray-600 mb-8 md:mb-10 leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4 font-semibold">
                ...
                <button onClick={() => setActiveCategory('brahma')} className="w-full sm:w-auto text-gray-900 bg-white border border-gray-200 px-6 py-3 md:py-4 rounded-full hover:border-amber-500 hover:text-amber-600 hover:shadow-md transition-all duration-300 flex items-center justify-center gap-2">
                  <Search size={20} /> ดูทุกรุ่นในหมวดนี้
                </button>
              </div>
            </Reveal>
