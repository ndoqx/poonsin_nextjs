      ...
      <section className="relative h-screen flex flex-col items-center justify-center overflow-hidden bg-white">
        ...
        <div className="relative z-10 text-center flex flex-col items-center mt-20 px-4 w-full will-change-transform" style={{ transform: `translateY(${-scrollY * 0.5}px)`, opacity: Math.max(0, 1 - scrollY * 0.002) }}>
          ...
          <Reveal effect="fade-up" delay={500}>
            <Link
              href="/collection"
              className="group relative overflow-hidden bg-gray-900 text-white px-10 md:px-12 py-4 md:py-5 rounded-full font-bold text-base md:text-lg shadow-2xl hover:shadow-amber-500/30 transition-all duration-300 hover:-translate-y-1 inline-flex"
            >
