...
const COLLECTION_PRODUCTS: CollectionItem[] = [
  ...
  },
  {
    ...
    images: [
      ...
      "https://storage.googleapis.com/poonsinshop-images/images/modernpoom/small/ppms1.2.jpg"
    ]
  },
  {
    id: "sm-2",
...
function CollectionPageContent() {
  ...
  const [filter, setFilter] = useState<string>(() => (initialCat && FILTERS.includes(initialCat) ? initialCat : 'ทั้งหมด'));
