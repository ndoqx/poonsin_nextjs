      ...
      <section className="bg-white text-gray-900 py-24 md:py-32 px-6 relative overflow-hidden flex flex-col items-center justify-center min-h-[calc(100vh-100px)]">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 w-full">
          <Reveal effect="scale-up">
             ...
             <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tighter mb-6 md:mb-8 text-gray-900">
               พร้อมสำหรับสิ่งที่ดีที่สุด<br className="hidden sm:block"/>แล้วหรือยัง?
             </h2>
             ...
             <div className="flex justify-center gap-8 md:gap-10">
                <a href="https://www.facebook.com/share/16XBg3i9ou/?mibextid=wwXIfr" target="_blank" rel="noreferrer" className="group flex flex-col items-center gap-2 md:gap-3">
                   <div className="w-14 h-14 md:w-16 md:h-16 bg-gray-50 rounded-full flex items-center justify-center text-gray-400 group-hover:bg-[#1877F2] group-hover:text-white transition-all duration-300 shadow-sm group-hover:shadow-lg group-hover:-translate-y-1">
                     <Facebook size={28} />
                   </div>
                ...
                <a href="https://www.facebook.com/share/16XBg3i9ou/?mibextid=wwXIfr" target="_blank" rel="noreferrer" className="group flex flex-col items-center gap-2 md:gap-3">
                   <div className="w-14 h-14 md:w-16 md:h-16 bg-gray-50 rounded-full flex items-center justify-center text-gray-400 hover:bg-gradient-to-tr hover:from-[#f09433] hover:via-[#dc2743] hover:to-[#bc1888] group-hover:text-white transition-all duration-300 shadow-sm group-hover:shadow-lg group-hover:-translate-y-1">
                     <Instagram size={28} />
                   </div>
                   <span className="text-[10px] md:text-xs uppercase tracking-widest font-bold text-gray-400 group-hover:text-[#dc2743] transition-colors">Instagram</span>
                </a>
             </div>
          </Reveal>
        </div>
